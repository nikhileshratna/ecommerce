      ...
      <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
        ...
        {loading ? (
          ...
          <div className='flex flex-col gap-1'>
            ...
            <div>
              <p className='text-slate-600 font-medium my-1'>How to Use: </p>
              <p>{data?.howToUse}</p>
            </div>
            <div>
              <p className='text-slate-600 font-medium my-1'>Benefits: </p>
              <p>{data?.benefits}</p>
            </div>
            <div>
            ...
            <div>
              <p className='text-slate-600 font-medium my-1'>Review: </p>
              <p>{data?.review}</p>
            </div>
          </div>
        )}
